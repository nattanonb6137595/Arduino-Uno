...
void loop()
{
 ...
 // โค้ดสำหรับสั่งให้ Relay ทำงานตามอุณหภูมิที่กำหนด
  if (t > hightemp){  // ตั้งค่าอุณหภูมิที่ต้องการให้รีเลย์ต่อวงจรต้องเกินอุณหภูมิเท่าไหร่
...
// . lcd.clear();
 ...
 //  lcd.print("Temp Over"); 
     lcd.setCursor(0,1);
     lcd.print("Temp High:PumpON"); 
     delay(1000);   
    }
  

    if (t < lowtemp){ // ตั้งค่าอุณหภูมิที่ต้องการให้รีเลย์ตัดวงจร ต้องต่ำกว่าเท่าไหร่
